...
int main(int argc, char* argv[]) {
    ...
    // Load Flappy Bird
    SDL_Surface* birdSurface = SDL_LoadBMP("bird.bmp");
    if (!birdSurface) {
    ...
    // Load Ground
    SDL_Surface* groundSurface = SDL_LoadBMP("ground.bmp");
    if (!groundSurface) {
    ...
    // Load Obstacle Placeholder (for simplicity, using ground image)
    SDL_Surface* obstacleSurface = SDL_LoadBMP("obstacle.bmp");
    if (!obstacleSurface) {
